...
Can be activated via D-Bus `qdbus6 org.lxqt.panel.wingmenu /wingmenu toggle` (or wingmenu2, wingmenu3, etc). Exact command is available in the Settings window.
